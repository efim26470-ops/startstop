...
PWA-тренажёр реакции и внимания для GitHub Pages. Версия v5 переработана под iOS/Safari/PWA и получила новый самостоятельный Launch/Pulse-экран без копирования исходного Reflex-дизайна.
...
- Обновлён service worker cache до `neurotap-v5.0.0`.
